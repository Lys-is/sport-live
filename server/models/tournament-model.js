...
import judge from "../controllers/api/judge/index.js";
import commentator from "../controllers/api/commentator/index.js";
...
const Tournament = new Schema({
   ...
   application_campaign: {
      ...
      fee_type: {
         type: String,
         enum: ["none", "team", "personal", "application"],
         default: "none",
      },
...
Tournament.plugin(mongooseAutoPopulate);
export default model("Tournament", Tournament);
